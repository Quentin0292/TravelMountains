...
const Testimonial = () => {
  return (
    <section className="testimonials">
      ...
      <p className="quote">
        I never understood why people cared so much about mountains. But then I
        wen on one of these tours. Now I can't understand people who{" "}
        <em>don't</em> care about mountains!
      </p>
      <p className="author">- Elie Shopick</p>
      <p className="quote">
        If you wan't to understand the universe, head to the mountains. I mean,
